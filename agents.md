...
- **Live Tide Data:** Integrate the free Open-Meteo Marine API into `maritimeMath.js` to replace the static `1.5m` tidal height with real-time dynamic tide data based on vessel ETA.
</what-to-build-next>
