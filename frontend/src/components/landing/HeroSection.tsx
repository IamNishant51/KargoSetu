        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 text-center lg:text-left z-10">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-[76px] font-extrabold tracking-tighter mb-6 leading-[1.05] font-sans">
              <span className="text-[#0F172A] block mb-2">
                Smarter Decisions.
              </span>
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
              KargoSetu empowers maritime professionals with real-time insights,
              accurate forecasts, and AI-driven intelligence to navigate global
            ...
            <div className="relative z-10 w-full max-w-2xl">
              ...
              <div className="mt-8 bg-white/90 backdrop-blur-md rounded-2xl p-6 shadow-xl shadow-slate-200/40 border border-slate-200/60 w-full max-w-md lg:max-w-[480px] z-20 mx-auto transition-transform duration-300 ">
                ...
                <div className="grid grid-cols-2 gap-5 divide-x divide-slate-100">
                  ...
                  <div className="pr-1">
                    <p className="text-[11px] sm:text-xs text-slate-500 font-semibold mb-1.5 uppercase tracking-wider truncate">
                      Baltic Dry Index
                    </p>
                    <div className="flex items-baseline gap-2 mb-2 flex-wrap">
                      <span className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-mono tracking-tighter">
                        1,842
                      </span>
                      <span className="text-[10px] sm:text-[11px] font-bold text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded-md border border-emerald-100">
                        +2.4%
                      </span>
                    </div>
                    ...
                    <div className="h-8 w-full my-2 relative">
                      ...
                      <svg
                        viewBox="0 0 120 30"
                        className="w-full h-full stroke-emerald-500 relative z-10 drop-shadow-sm"
                        fill="none"
                        strokeWidth="2.5"
                        strokeLinecap="round"
                  ...
                  <div className="pl-5">
                    ...
                    <div className="flex items-baseline gap-2 mb-2 flex-wrap">
                      <span className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-mono tracking-tighter">
                        <span className="text-slate-400 font-medium text-lg mr-0.5">
                          $
                        </span>
                        18.6k
                      </span>
