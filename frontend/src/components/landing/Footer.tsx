      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-sm font-medium">
              AI-Powered Maritime Intelligence and Dual-Ended Port Constraint
              Resolution Platform. Built for the Smart India Hackathon 2026
              (SIH26006) for the Ministry of Steel & SAIL.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-slate-200/80 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-500 font-medium">
          <p suppressHydrationWarning>
            &copy; 2026 KargoSetu. Built for Smart India Hackathon 2026. All
            rights reserved.
          </p>
