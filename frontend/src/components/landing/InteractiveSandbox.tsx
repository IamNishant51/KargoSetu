...
export default function InteractiveSandbox() {
  const [activeTab, setActiveTab] = useState<"constraint" | "forecast" | "roi">(
    "constraint",
  );
...
// Calculate average over the forecast period
    ...
    p50 = Math.round(
      forecastData.reduce((acc: number, val: ForecastDay) => acc + val.p50, 0) /
        forecastData.length,
    );
    p90 = Math.round(
      forecastData.reduce((acc: number, val: ForecastDay) => acc + val.p90, 0) /
        forecastData.length,
    );
  }
...
// ROI calculation
  ...
  const demurrageSavingsINR_Cr = (
    (demurrageSavingsUSD * 86.5) /
    10000000
  ).toFixed(1);
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span
                      ...
                      className="font-mono font-bold text-slate-900 bg-slate-100 px-2.5 py-1 rounded-md text-sm"
                    >
                      {formatNum(volume)} MT
                    </span>
                  </div>
              ...
              <div className="lg:col-span-7 bg-white text-slate-900 p-6 sm:p-8 rounded-2xl shadow-xs border border-slate-200/90 space-y-6">
                    ...
                    <div className="flex items-center gap-2">
                      {evaluateMutation.isPending ? (
                        ...
                        <div className="flex items-center gap-2 text-amber-700 font-bold text-lg">
                          ...
                          <span>
                            Direct Berthing Exceeds Draft &middot; Split
                            Required
                          </span>
                        </div>
                      )}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  <div className="bg-emerald-50/70 p-3.5 rounded-xl border border-emerald-200">
                    <span className="text-[10px] text-emerald-800 uppercase font-semibold block mb-1">
                      Dynamic Tide
                    </span>
                    <span className="text-lg font-bold text-emerald-700 font-mono">
                      +{currentPortInfo.tide}m
                    </span>
                  ...
                  <div className="bg-amber-50/70 p-3.5 rounded-xl border border-amber-200">
                    <span className="text-[10px] text-amber-800 uppercase font-semibold block mb-1">
                      Vessel Draft
                    </span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 space-y-6 bg-white p-6 sm:p-7 rounded-2xl border border-slate-200/80 shadow-xs">
                <div className="border-b border-slate-100 pb-3">
                  <h3 className="font-bold text-slate-900 text-base">
                    What-If Market Shock Engine
                  </h3>
                  <p className="text-xs text-slate-500 mt-0.5">
                    Stress-test Baltic Dry volatility and geopolitical risk
                  </p>
                </div>
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-2 text-xs text-slate-600">
                  ...
                  <p className="leading-relaxed">
                    Trained on historical BDRY and Baltic Capesize fixtures.
                    Computes 30, 60, and 90-day probabilistic quantile bounds
                    (P10, P50, P90) to detect optimal Contracts of Affreightment
                    (CoA) booking windows.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 bg-white text-slate-900 p-6 sm:p-8 rounded-2xl shadow-xs border border-slate-200/90 space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <div
                      className="text-xl sm:text-2xl font-bold font-mono text-slate-900"
                      suppressHydrationWarning
                    >
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-xs sm:text-sm text-slate-700 space-y-1">
                  ...
                  <p className="leading-relaxed">
                    ...
                    in price stability for upcoming coking coal shipments.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#F8FAFC] rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-xs animate-in fade-in duration-200">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 space-y-5 bg-white p-6 sm:p-7 rounded-2xl border border-slate-200/80 shadow-xs">
                <div className="border-b border-slate-100 pb-3">
                  <h3 className="font-bold text-slate-900 text-base">
                    PSU Procurement Baseline
                  </h3>
                  <p className="text-xs text-slate-500 mt-0.5">
                    Tailored for SAIL, RINL, NMDC, and NTPC Dry Bulk Logistics
                  </p>
                </div>
              ...
              <div className="lg:col-span-7 bg-white text-slate-900 p-6 sm:p-8 rounded-2xl shadow-xs border border-slate-200/90 space-y-6">
                <div className="border-b border-slate-100 pb-4">
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Direct freight optimization via CoA timing & split logistics
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div className="bg-blue-50/70 p-3.5 rounded-xl border border-blue-200">
                    <span className="text-[10px] text-blue-800 uppercase font-semibold block mb-1">
                      CO2 Reduction
                    </span>
                    <span
                      ...
                      suppressHydrationWarning
                    >
                      {formatNum(co2AvoidedMT)} MT
                    </span>
                    <span className="text-[10px] text-blue-600 block mt-0.5">
                      IMO EEXI green fleet
                    </span>
                  </div>
                </div>

                <div className="bg-emerald-50/70 border border-emerald-200 rounded-xl p-4 text-xs sm:text-sm text-emerald-900">
                  <span className="font-bold block mb-1 text-emerald-800">
                    SIH 26006 Value Proposition
                  </span>
                  KargoSetu transforms dry bulk shipping from a volatile spot
                  expenditure into a highly predictable, mathematically shielded
                  procurement pipeline for the Ministry of Steel.
                </div>
              </div>
            </div>
          </div>
