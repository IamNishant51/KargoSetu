      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 text-base sm:text-lg">
            Answers to common questions about KargoSetu&apos;s algorithms, datasets, and SIH 26006 problem specifications.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className={`w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 text-slate-600 transition-transform duration-200 ${isOpen ? 'rotate-180 bg-slate-200 text-slate-900' : ''}`}>
                    <ChevronDown size={16} />
                  </div>
                </button>

                {isOpen && (
                  <div className="px-6 pb-6 pt-1 text-slate-600 text-sm sm:text-base leading-relaxed border-t border-slate-100 animate-in fade-in duration-150">
                    {faq.a}
                  </div>
                )}
              </div>
