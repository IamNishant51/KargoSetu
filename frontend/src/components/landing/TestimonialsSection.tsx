...
const TESTIMONIALS = [
  {
    quote: "KargoSetu has completely modernized our bulk coking coal procurement. Predicting seasonal Baltic rate dips and locking in Contracts of Affreightment at the bottom of the cycle projected ₹35+ Crores in annual freight savings for our fleet operations.",
    author: "R. K. Verma",
  ...
  {
    quote: "Haldia's 7.5m riverine draft previously caused recurring grounding hazards and $30k/day demurrage bills. KargoSetu's dynamic tide solver and auto-splitting algorithm automatically routes lighterage via Sandheads, eliminating port bottleneck delays.",
  ...
  {
    quote: "The TensorFlow.js LSTM multi-horizon engine gives us deterministic P10/P50/P90 confidence bounds that correlate directly with global BDRY and commodity crack spreads. It transforms gut-feel chartering into quantitative certainty.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-500 text-base sm:text-lg">
            Engineered to fulfill the operational mandates of Indian Steel PSUs and Major Port Authorities.
          </p>
        </div>
          ...
          {TESTIMONIALS.map((t, idx) => (
            ...
            >
              ...
              <div className="pt-6 border-t border-slate-200/80">
                ...
                <div className="text-xs font-medium text-slate-600 mb-1">{t.title}</div>
                <div className="text-xs text-slate-400 font-semibold">{t.org}</div>
