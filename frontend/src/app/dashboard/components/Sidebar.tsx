...
// Close sidebar on route change on mobile
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`w-64 bg-[#0A1727] text-white flex flex-col fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 ease-in-out md:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        {/* Logo Area */}
